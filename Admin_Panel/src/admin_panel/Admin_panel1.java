...
public class Admin_panel1 extends javax.swing.JFrame {
   ...
   private void checkEmployeeId() {
    ...
    try {
        ...
        // Query Educational Background (Bachelor, Masteral, Doctorate)
        ...
        if (rs.next()) {
            ...
            jdcbachelorGraduation.setDate(jdcbachelor != null ? jdcbachelor : null);
            ...
            jdcmasteralGraduation.setDate(jdcmasteral != null ? jdcmasteral : null);
            ...
            jdcdoctorateGraduation.setDate(jdcdoctorate != null ? jdcdoctorate : null);
        ...
        if (rs.next()) {
            ...
            java.sql.Date date = rs.getDate("years_of_employment");
            jdcyoe.setDate(date != null ? date : null);
    ...
    private void erase()
    {
        ...
        jdcbachelorGraduation.setDate(null); 
        ...
        jdcmasteralGraduation.setDate(null); 
        ...
        jdcdoctorateGraduation.setDate(null); 
    ...
    private void initComponents() {
        ...
        jdcmasteralGraduation = new com.toedter.calendar.JDateChooser();
        jdcdoctorateGraduation = new com.toedter.calendar.JDateChooser();
        jdcbachelorGraduation = new com.toedter.calendar.JDateChooser();
        ...
        jTabbedPane1.setBackground(new java.awt.Color(54, 179, 71));
        jTabbedPane1.setTabPlacement(javax.swing.JTabbedPane.LEFT);

        jPanel2.setBackground(new java.awt.Color(75, 190, 94));
        ...
        jPanel3.setBackground(new java.awt.Color(80, 190, 76));
        ...
        txtEmpIdEducational.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtEmpIdEducationalKeyTyped(evt);
            }
        });
        ...
        jPanel3.add(jdcmasteralGraduation, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 400, 140, -1));
        jPanel3.add(jdcdoctorateGraduation, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 400, 140, -1));
        jPanel3.add(jdcbachelorGraduation, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 400, 140, -1));

        jTabbedPane1.addTab("Educational Background", jPanel3);

        jPanel4.setBackground(new java.awt.Color(64, 206, 90));
        ...
        txtEmpIdEmployment.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtEmpIdEmploymentKeyTyped(evt);
            }
        });
        ...
        getContentPane().add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 970, 650));
    ...
    private void btnProcessEducationalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcessEducationalActionPerformed
        ...
        try {
            ...
            String bachelorInstitution = txtBachelorInstitution.getText();
             java.util.Date selectedDate1 = jdcbachelorGraduation.getDate();
        ...
        if (gpa < 0 || gpa > 4.0) {
            ...
            java.util.Date selectedDatemasteral1 = jdcmasteralGraduation.getDate();
        ...
        if (selectedDatemasteral1 != null) {
            ...
            java.util.Date sqlBirthdatedoc = jdcmasteralGraduation.getDate();
...
if (employment != null) { // Check employment, not employment1
    employment1 = new java.sql.Date(employment.getTime());
        ...
        if (rbtnRetired.isSelected()) {
            ...
            if(btnProcessEmployment.getText().equals("Add"))
            {
              ...
              ps.setDate(5, employment1); // Now correctly handles NULL if no date is chosen
            ...
            else
            {
                ...
                ps.setDate(4, employment1); // Now correctly handles NULL if no date is chosen
    ...
    private void txtEmpIdEducationalKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtEmpIdEducationalKeyTyped
        // TODO add your handling code here:
        checkEmployeeId();
    }//GEN-LAST:event_txtEmpIdEducationalKeyTyped

    private void txtEmployee_IdKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtEmployee_IdKeyTyped
checkEmployeeId();        // TODO add your handling code here:
    }//GEN-LAST:event_txtEmployee_IdKeyTyped

    private void txtEmpIdEmploymentKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtEmpIdEmploymentKeyTyped
        // TODO add your handling code here:
    checkEmployeeId();      // TODO add your handling code here:
    ...
    private com.toedter.calendar.JDateChooser jdcbachelorGraduation;
    private com.toedter.calendar.JDateChooser jdcbirthdate;
    private com.toedter.calendar.JDateChooser jdcdoctorateGraduation;
